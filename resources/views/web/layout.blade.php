...
<head>
    ...
    <link rel="icon" type="image/png" href="{{asset(system_config('weblogo'))}}">

    <!-- Add to homescreen for Chrome on Android -->
    <meta name="mobile-web-app-capable" content="yes">
    <link rel="icon" sizes="192x192" href="{{asset(system_config('weblogo'))}}">
    ...
    <meta name="msapplication-TileImage" content="{{asset(system_config('weblogo'))}}">
