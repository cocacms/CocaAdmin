...
@section('content')
    <form class="layui-form" style="width: 80%;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" value="" class="layui-input" lay-verify="required" placeholder="请输入字典名">
            </div>
        </div>
        ...
        <div class="layui-form-item" id="kvs">
            ...
            @endphp
            <div class="layui-input-block">
                <input type="text" name="content[{{$rand}}][k]" value="" class="layui-input kvinput" lay-verify="required" placeholder="请输入键">
                <input type="text" name="content[{{$rand}}][v]" value="" class="layui-input kvinput" lay-verify="required" placeholder="请输入值">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit="" lay-filter="submit" data-url="{{route('dictionary@postAdd')}}">立即提交</button>
