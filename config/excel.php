...
return array(
    ...
    'cache'      => [
        ...
        */
        ...
        |
        */
        'driver'   => env('EXCEL_DRIVER', 'discISAM'),
        ...
        */
        ...
        'dir'      => storage_path('excel_cache')
    ],

    'properties' => [
        'creator'        => 'Zhongshang',
        'lastModifiedBy' => 'Zhongshang',
        'title'          => 'Zhongshang Order',
        'description'    => 'Zhongshang Order',
        'subject'        => 'Zhongshang Order export',
        'keywords'       => 'Zhongshang, excel, export',
        'category'       => 'Order Excel',
        'manager'        => 'Zhongshang',
        'company'        => 'Zhongshang',
    ],
